...
public class PlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        genre_click=findViewById(R.id.genre_button);
        ...
        handler = new Handler();
        genre_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Thread thread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            Intent in = getIntent();
                            genre.setText("please wait...");
                            System.out.println(in.getStringExtra("music_path"));
                            Predict p = new Predict();
                            String k=p.httpConn(in.getStringExtra("music_path"));
                            genre.setText(k);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
